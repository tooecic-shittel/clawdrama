  ...
  <div class="shell">
    ...
    <header class="header">
      ...
      <nav class="header-nav">
        ...
        <NuxtLink v-if="isAdmin" to="/admin/users" class="nav-link nav-link-admin" :class="{ active: route.path === '/admin/users' }" title="仅管理员可见">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="header-right">
        ...
        <div v-if="isAuthenticated && user" class="user-menu" :class="{ open: userMenuOpen }" @click.stop>
          ...
          <div v-if="userMenuOpen" class="user-dropdown">
            ...
            <NuxtLink to="/invite" class="user-dropdown-item" @click="userMenuOpen = false">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
