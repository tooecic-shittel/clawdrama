...
import { STYLE_OPTIONS, styleLabel } from '~/composables/useStyleLabels'
...
.episode-badge svg { color: var(--accent-text); }
...
.empty-card:hover .empty-icon { background: var(--accent-bg); color: var(--accent-text); }
